<?php
	...
	if (function_exists('register_sidebar')){
		...
		register_sidebar(array('id' => 'footer-sub-widgets-1'	, 'name' => __('Footer bottom widget area 1',EWF_SETUP_THEME_DOMAIN)	, 'description'   => __('The section located below footer',EWF_SETUP_THEME_DOMAIN)			, 'before_title'  => '<h3 class="widget-title"><span>',		'after_title'   => '</span></h3>', 		'before_widget' => '<div id="%1$s" class="widget %2$s">',		'after_widget'  => '</div>' ));
		register_sidebar(array('id' => 'footer-sub-widgets-2'	, 'name' => __('Footer bottom widget area 2',EWF_SETUP_THEME_DOMAIN)	, 'description'   => __('The section located below footer',EWF_SETUP_THEME_DOMAIN)			, 'before_title'  => '<h3 class="widget-title"><span>',		'after_title'   => '</span></h3>', 		'before_widget' => '<div id="%1$s" class="widget %2$s">', 		'after_widget'  => '</div>' ));
		register_sidebar(array('id' => 'footer-sub-widgets-3'	, 'name' => __('Footer bottom widget area 3',EWF_SETUP_THEME_DOMAIN)	, 'description'   => __('The section located below footer',EWF_SETUP_THEME_DOMAIN)			, 'before_title'  => '<h3 class="widget-title"><span>',		'after_title'   => '</span></h3>', 		'before_widget' => '<div id="%1$s" class="widget %2$s">', 		'after_widget'  => '</div>' ));
		register_sidebar(array('id' => 'footer-sub-widgets-4'	, 'name' => __('Footer bottom widget area 4',EWF_SETUP_THEME_DOMAIN)	, 'description'   => __('The section located below footer',EWF_SETUP_THEME_DOMAIN)			, 'before_title'  => '<h3 class="widget-title"><span>',		'after_title'   => '</span></h3>', 		'before_widget' => '<div id="%1$s" class="widget %2$s">', 		'after_widget'  => '</div>' ));
	}
