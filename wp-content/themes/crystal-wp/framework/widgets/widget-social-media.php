<?php 
	...
	class ewf_widget_social_media extends WP_Widget {
		...
		function form( $instance ) {
			...
			$instance['profile_facebook'] 	= esc_url( $instance['profile_facebook'] );
			$instance['profile_twitter'] 	= esc_url( $instance['profile_twitter'] );
			$instance['profile_plus'] 		= esc_url( $instance['profile_plus'] );
			$instance['profile_linkedin'] 	= esc_url( $instance['profile_linkedin'] );
			$instance['profile_instagram'] 	= esc_url( $instance['profile_instagram'] );
			$instance['profile_flickr'] 	= esc_url( $instance['profile_flickr'] );
			$instance['profile_dribbble'] 	= esc_url( $instance['profile_dribbble'] );
			$instance['profile_pinterest'] 	= esc_url( $instance['profile_pinterest'] );
			$instance['profile_tumblr'] 	= esc_url( $instance['profile_tumblr'] );
			$instance['profile_youtube'] 	= esc_url( $instance['profile_youtube'] );
			$instance['profile_vimeo'] 		= esc_url( $instance['profile_vimeo'] );
			$instance['profile_rss'] 		= esc_url( $instance['profile_rss'] );
			...
			<div class="ewf-meta">
				...
				<p>
					...
					<input id="<?php echo $this->get_field_id( 'profile_linkedin' ); ?>" name="<?php echo $this->get_field_name( 'profile_linkedin' ); ?>" value="<?php echo $instance['profile_linkedin']; ?>" style="width:100%;" />
				</p>
				...
				<p>
					...
					<input id="<?php echo $this->get_field_id( 'profile_vimeo' ); ?>" name="<?php echo $this->get_field_name( 'profile_vimeo' ); ?>" value="<?php echo $instance['profile_vimeo']; ?>" style="width:100%;" />
				</p>
