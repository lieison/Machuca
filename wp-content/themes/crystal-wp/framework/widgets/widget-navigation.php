<?php 
	...
	class ewf_widget_navigation extends WP_Widget {
		...
		#
			...
			$show_parent 	= esc_html( $instance['show-parent'] );
			$page_nav 		= esc_html( $instance['nav-page'] );
		...
		#
			...
			$instance['show-parent'] = sanitize_text_field( $new_instance['show-parent'] );
			$instance['nav-page'] = sanitize_text_field( $new_instance['nav-page'] );
		...
		#
			...
			$instance['show-parent'] = esc_html( $instance['show-parent'] );
			$instance['nav-page'] = esc_html( $instance['nav-page'] );
