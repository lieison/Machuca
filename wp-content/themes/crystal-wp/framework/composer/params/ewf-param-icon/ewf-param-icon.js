...
(function($){
	...
	var ewf_param_icon_window = '';
	
    $('.vc_panel.vc_shortcode-edit-form .wpb_el_type_ewf-icon i').click(function(){
	...
	$('.vc_panel.vc_shortcode-edit-form .wpb_el_type_ewf-icon .ewf-icon-ct-cancel').click(function(){
	...
	$('.vc_panel.vc_shortcode-edit-form .wpb_el_type_ewf-icon .ewf-icon-ct-selection').click(function(){
		var field = $(this).closest('.wpb_el_type_ewf-icon');
	
		$('.ewf-icon-ct-change').click(); 
	});
	
	$('.vc_panel.vc_shortcode-edit-form .wpb_el_type_ewf-icon .ewf-icon-ct-change').click(function(){
		var field = $(this).closest('.wpb_el_type_ewf-icon');
	...
	$('.vc_panel.vc_shortcode-edit-form .wpb_el_type_ewf-icon ul').each(function(){
		var seletected_field = $(this).closest('.wpb_el_type_ewf-icon');
