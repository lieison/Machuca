...
#
	...
	include_once ('components/vc_ewf_portfolio_isogrid/vc_ewf_portfolio_isogrid.php');
	...
	// include_once ('components/vc_ewf_slider_features.php');
...
#	
	function ewf_composer_custom_classes($class_string, $tag) {
		...
		$class_string = preg_replace('/vc_col-sm-(\d{1,2})/', 'ewf-span$1', $class_string);
...
#	Add css class field to EWF components
#	
	$ewf_composer_class = true;
	$ewf_composer_class_field = array( 
		"type" => "textfield", 
		"holder" => "div", 
		"class" => "", 
	...
	vc_add_param('ewf-button'			, $ewf_composer_class_field);
	vc_add_param('ewf-divider'			, $ewf_composer_class_field);
	vc_add_param('ewf-headline'			, $ewf_composer_class_field);
	vc_add_param('ewf-team-member'		, $ewf_composer_class_field);
	vc_add_param('ewf-client-logo'		, $ewf_composer_class_field);
	vc_add_param('ewf-map'				, $ewf_composer_class_field);
	vc_add_param('ewf-milestone'		, $ewf_composer_class_field);
	vc_add_param('ewf-iconbox'			, $ewf_composer_class_field);
	vc_add_param('ewf-pricing-item'		, $ewf_composer_class_field);
	vc_add_param('ewf-piechart'			, $ewf_composer_class_field);
	vc_add_param('ewf-testimonial'		, $ewf_composer_class_field);
	vc_add_param('ewf-message'			, $ewf_composer_class_field);
	vc_add_param('ewf-social-icons'		, $ewf_composer_class_field);
	vc_add_param('ewf-progress'			, $ewf_composer_class_field);
	
	// vc_add_param('ewf_processh_item'	, $ewf_composer_class_field);
