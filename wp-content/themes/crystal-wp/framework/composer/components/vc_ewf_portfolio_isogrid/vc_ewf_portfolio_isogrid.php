<?php
	...
	//	Register image size
	//
	add_image_size( 'ewf-portfolio-isogrid'											, 570, 570, true);
							...
							<div class="portfolio-item-preview">
								...
								<div class="portfolio-item-overlay">
									...
									<div class="portfolio-item-overlay-actions">
										...
										<a href="'.$image_extra_large_preview[0].'" class="magnificPopup-gallery portfolio-item-zoom">
	...
	//
		if ($wrapper){
			$src = '<ul class="portfolio-items portfolio-strip fixed'.$class_extra.'" data-display="'.$display.'" data-style="'.$style.'">'.$src.'</ul>';
		...
		//
			...
			$src_header = '<div class="ewf-row title-filter">';
