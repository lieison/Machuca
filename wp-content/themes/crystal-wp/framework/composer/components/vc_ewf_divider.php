	...
	vc_map( array(
	   ...
	   "params" => array(
		  ...
		  array(
			 ...
			 "value" => array(
				__('Single line', EWF_SETUP_THEME_DOMAIN) => 'single-line', 
				__('Double line', EWF_SETUP_THEME_DOMAIN) => 'double-line', 
				__('Dotted line', EWF_SETUP_THEME_DOMAIN) => 'single-dotted', 
				__('Double dotted line', EWF_SETUP_THEME_DOMAIN) => 'double-dotted'
				),
