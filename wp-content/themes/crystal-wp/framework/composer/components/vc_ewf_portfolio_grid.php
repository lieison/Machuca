<?php
	...
	#
	add_image_size( 'ewf-portfolio-grid', 570, 570, true);
	...
	function ewf_vc_portfolio_grid( $atts, $content ) {
	   ...
	   extract($options);
		...
		echo '<div class="portfolio-grid'.$class_extra.'">';
		...
		while ($wp_query_portfolio_grid->have_posts()) : $wp_query_portfolio_grid->the_post();
			...
			$_ewf_rowItems++;
			  ...
			  echo '<div class="ewf-span'.$_ewf_span.'">
					<div class="portfolio-item portfolio-strip">
						<div class="portfolio-item-preview">
							...
							<div class="portfolio-item-overlay">
								...
								<div class="portfolio-item-overlay-actions">
									...
									<a class="portfolio-item-link" href="'.get_permalink().'">
										<i class="ifc-link"></i>
									</a>
						...
						if ($ewf_project_client){
						   echo '<h3>'.__('Client', EWF_SETUP_THEME_DOMAIN).':
									<span>'.$ewf_project_client.'</span>
								</h3>';
						}
						
						if ($ewf_project_url){
						   echo '<h3>'.__('URL', EWF_SETUP_THEME_DOMAIN).':
									<span>
										<a href="'.$ewf_project_url.'">'.$ewf_project_url.'</a>
									</span>
								</h3>';
						}
